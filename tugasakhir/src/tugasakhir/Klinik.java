...
public class Klinik {
   ...
   static void showAll() {
    ...
    while (true) {
        ...
        System.out.println("------------------------------------------------------------------------------------------------------------------------------------");
        System.out.printf("| %-2s | %-15s | %-14s | %-14s | %-14s | %-15s | %-16s | %-17s |\n", "", "Subtotal Hal " + page, "", "", "", "", "", subtotalHalaman);
        System.out.println("------------------------------------------------------------------------------------------------------------------------------------");
    ...
    int nomor []=new int[8];
    int kodeLayanan []=new int[8];
    int jenisPelanggan []=new int[8];
    int jumlahKunjungan []=new int[8];
            for (int a = 0; a <= 7;a ++) {
            System.out.println("\nDATA KE - "+a);
            System.out.println("==========================================");
            ...
            kodeLayanan[a] = input.nextInt();
            System.out.print("Jenis Pelanggan [1=Reguler, 2=VIP]  : ");
            jenisPelanggan[a] = input.nextInt();
            System.out.print("Jumlah Kunjungan [1 .. 10]          : ");
            jumlahKunjungan[a] = input.nextInt();
            System.out.println("==========================================");
            pelangganData.add(new Klinik(nama[a], alamat[a], nomor[a], kodeLayanan[a], jenisPelanggan[a], jumlahKunjungan[a]));  
            }
    }
