...
static void cetakStruk(Klinik pelanggan) {
    ...
    System.out.printf(" Harga Layanan       : %d\n", hargaLayanan);
    System.out.printf(" Jenis Pelanggan     : %s\n", pelanggan.jenisPelanggan == 1 ? "Reguler" : "VIP");
    System.out.printf(" Jumlah Kunjungan    : %d\n", pelanggan.jumlahKunjungan);
...
static void tambahData() throws IOException {
    ...
    while (true) {
        ...
        // Cetak struk setelah menambah data
        cetakStruk(pelangganBaru);
